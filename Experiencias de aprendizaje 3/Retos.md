...
private:
	...
	vector<glm::vec3> spherePositions; // Posiciones de esferas
	glm::vec3 selectedSphere; // Esfera seleccionada
...
void ofApp::draw() {
	...
	for (auto & pos : spherePositions) {
		if (sphereSelected && pos == selectedSphere) {
			ofSetColor(0, 255, 0); // Verde si está seleccionada
			ofDrawSphere(pos, 8);
			ofSetColor(255, 200, 0);
		} else {
			ofDrawSphere(pos, 5);
...
int main() {
	...
	ofSetupOpenGL(1024, 768, OF_WINDOW); // ancho, alto, modo ventana
